...
from src.rnn.genotypes import PRIMITIVES, STEPS, CONCAT, Genotype
from src.rnn.model import DARTSCell, RNNModel
from src.rnn.args import args, beta_decay_scheduler
  ...
  def cell(self, x, h_prev, x_mask, h_mask):
    ...
    for i in range(STEPS):
      ...
      if args.auxiliary_skip:
          # Zilly et al. High-way RNN
          # _in = states + c * (h - states)
          s += torch.sum(states,dim=0) * beta_decay_scheduler.decay_rate
